      ...
      <div style={{ display: 'flex' }}>
        ...
        <main style={{ flex: '1', padding: '24px' }}>
          ...
          <div style={{ backgroundColor: 'white', borderRadius: '8px', boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1)', padding: '24px', marginBottom: '24px' }}>
            ...
            <div style={{ marginBottom: '24px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                />
                <span style={{ fontSize: '16px', fontWeight: '500', color: '#1f2937' }}>Object Oriented Programming</span>
              </div>
            </div>
          ...
          <div style={{ marginBottom: '32px' }}>
            <h3 style={{ fontSize: '18px', fontWeight: '500', color: '#1f2937', marginBottom: '16px' }}>ข้อมูลไฟล์ชิ้นงาน</h3>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ backgroundColor: '#f97316', color: 'white' }}>
                    ...
                    <th style={{ padding: '12px 16px', textAlign: 'left', fontWeight: '600', fontSize: '14px', width: '150px' }}>ประเภท</th>
                    <th style={{ padding: '12px 16px', textAlign: 'left', fontWeight: '600', fontSize: '14px' }}>ชื่อไฟล์</th>
                ...
                <tbody>
                  <tr style={{ borderBottom: '1px solid #e5e7eb' }}>
                    ...
                    <td style={{ padding: '12px 16px', fontSize: '14px', color: '#374151' }}>รายงาน</td>
                    <td style={{ padding: '12px 16px', fontSize: '14px', color: '#374151' }}>รายงานการพัฒนาโครงงานเว็บขายอุปกรณ์กีฬา</td>
                  ...
                  <tr style={{ borderBottom: '1px solid #e5e7eb' }}>
                    ...
                    <td style={{ padding: '12px 16px', fontSize: '14px', color: '#374151' }}>วิดีโอ</td>
                  ...
                  <tr style={{ borderBottom: '1px solid #e5e7eb' }}>
                    ...
                    <td style={{ padding: '12px 16px', fontSize: '14px', color: '#374151' }}>รูปภาพ</td>
                    <td style={{ padding: '12px 16px', fontSize: '14px', color: '#374151' }}>รูปแสดงหน้าหลักของโครงงาน</td>
                    <td style={{ padding: '12px 16px', textAlign: 'center' }}>
                      <button style={{
                        backgroundColor: '#3b82f6',
                        color: 'white',
                  ...
                  <tr>
                    ...
                    <td style={{ padding: '12px 16px', fontSize: '14px', color: '#374151' }}>Source Code</td>
                    <td style={{ padding: '12px 16px', fontSize: '14px', color: '#6b7280', fontStyle: 'italic' }}>ไม่มี</td>
                    <td style={{ padding: '12px 16px', textAlign: 'center' }}>
          ...
          {/* Repository Section */}
          <div style={{ marginBottom: '32px' }}>
            <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', color: '#374151', marginBottom: '8px' }}>Repository</label>
          ...
          {/* ความคาดหวังเริ่มแรกเมื่อจะทำชิ้นงาน Section */}
          <div style={{ marginBottom: '24px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
              <label style={{ fontSize: '18px', fontWeight: '500', color: '#1f2937' }}>ความคาดหวังเริ่มแรกเมื่อจะทำชิ้นงาน</label>
              <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            ...
            <div style={{ backgroundColor: 'white', borderRadius: '8px', boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1)', overflow: 'hidden' }}>
              ...
              <div style={{ padding: '16px' }}>
                <textarea
                  ...
                  placeholder="ให้บอกความคาดหวังเริ่มแรกเมื่อจะทำชิ้นงาน"
                ></textarea>
              </div>
            </div>
          </div>

          {/* สิ่งที่ได้จากการทำชิ้นงาน Section */}
          <div style={{ marginBottom: '24px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
              <label style={{ fontSize: '18px', fontWeight: '500', color: '#1f2937' }}>สิ่งที่ได้จากการทำชิ้นงาน</label>
              <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            ...
            <div style={{ backgroundColor: 'white', borderRadius: '8px', boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1)', overflow: 'hidden' }}>
              ...
              <div style={{ padding: '16px' }}>
                <textarea
                  ...
                  placeholder="ให้บอกสิ่งที่ได้จากการทำชิ้นงาน เช่น 
...
• มีแรงบันดาลใจในการเรียน มากกว่าเรียนเพื่อให้ได้เกรด หรือ เพื่อให้สำเร็จการศึกษา"
          ...
          {/* สิ่งที่สะท้อนคิดจากการทำชิ้นงาน Section */}
          <div style={{ marginBottom: '24px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
              <label style={{ fontSize: '18px', fontWeight: '500', color: '#1f2937' }}>สิ่งที่สะท้อนคิดจากการทำชิ้นงาน</label>
              <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            ...
            <div style={{ backgroundColor: 'white', borderRadius: '8px', boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1)', overflow: 'hidden' }}>
              ...
              <div style={{ padding: '16px' }}>
                <textarea
                  ...
                  placeholder="ให้สะท้อนต่อสิ่งที่ได้เรียนรู้จากการทำชิ้นงาน ว่ามีผลอย่างไรต่อตนเอง มีการเปลี่ยนแปลงของความคิด วิธีคิด ความเชื่อ หรือไม่ และทำให้ตนเองมีความเปลี่ยนแปลงอะไรหรือไม่"
                ></textarea>
              </div>
            </div>
          </div>
