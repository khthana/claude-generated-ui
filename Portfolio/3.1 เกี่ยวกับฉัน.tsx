...
export default function LearningManagementSystem() {
  ...
  const [activeSubMenu, setActiveSubMenu] = useState('เกี่ยวกับฉัน');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          ...
          {/* Page Title */}
          <h1 className="text-2xl font-bold text-gray-800 mb-8">เกี่ยวกับฉัน</h1>
            ...
            <div className="p-6 min-h-96 bg-white">
              <div className="w-full h-full border-none outline-none resize-none bg-transparent">
                <div className="text-gray-400 italic">
                  เริ่มเขียนเกี่ยวกับตัวคุณที่นี่...
                </div>
              </div>
            </div>
