...
export default function LearningManagementSystem() {
  ...
  const [activeSubMenu, setActiveSubMenu] = useState('คุณวุฒิทางวิชาชีพ');
        ...
        <div className="flex">
          ...
          <main className="main-content">
            <nav className="breadcrumb">
              ...
              <span> &gt; </span>
              <span>คุณวุฒิทางวิชาชีพ</span>
            </nav>

            <div className="page-header">
              <h1 className="page-title">คุณวุฒิทางวิชาชีพ</h1>
              ...
              <div className="form-section">
                <div className="education-row">
                  <div className="education-field">
                    <label className="form-label">ชื่อ Certificate หรือ ประกาศนียบัตร</label>
                ...
                <div className="education-row">
                  <div className="education-field">
                    <label className="form-label">หน่วยงานที่ออก</label>
                    <input type="text" className="form-input" />
                  </div>
                </div>
                ...
                <div className="education-row">
                  <div className="education-field">
                    <label className="form-label">วันที่ได้คุณวุฒิ</label>
                ...
                <div className="education-row">
                  <div className="education-field">
                    <label className="form-label">ภาพ Certificate หรือ ประกาศนียบัตร</label>
