      ...
      <div style={{ display: 'flex' }}>
        ...
        <main style={{ flex: '1', padding: '24px' }}>
          ...
          <nav style={{ fontSize: '14px', color: '#6b7280', marginBottom: '24px' }}>
            ...
            <span style={{ color: '#3b82f6' }}>การฝึกงาน / สหกิจศึกษา</span>
          </nav>

          {/* Page Title */}
          <h1 style={{ fontSize: '24px', fontWeight: 'bold', color: '#1f2937', marginBottom: '32px' }}>การฝึกงาน / สหกิจศึกษา</h1>
          ...
          <div style={{ backgroundColor: 'white', borderRadius: '8px', boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1)', padding: '24px', marginBottom: '24px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '24px', marginBottom: '24px' }}>
              {/* ประเภท */}
              <div>
                <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', color: '#374151', marginBottom: '8px' }}>ประเภท</label>
                <select style={{
                  width: '100%',
                  padding: '8px 12px',
              ...
              {/* หน่วยงาน/บริษัท */}
              <div>
                <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', color: '#374151', marginBottom: '8px' }}>หน่วยงาน/บริษัท</label>
                <input
                  type="text"
                  style={{
                    width: '100%',
              ...
              {/* วันที่เริ่ม */}
              <div>
                <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', color: '#374151', marginBottom: '8px' }}>วันที่เริ่ม</label>
                <div style={{ position: 'relative' }}>
                  ...
                  />
                  <Calendar size={16} style={{ position: 'absolute', right: '12px', top: '50%', transform: 'translateY(-50%)', color: '#9ca3af' }} />
                </div>
              </div>

              {/* วันที่สิ้นสุด */}
              <div>
                <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', color: '#374151', marginBottom: '8px' }}>วันที่สิ้นสุด</label>
                <div style={{ position: 'relative' }}>
                  <input
                    type="text"
                    placeholder="DD/MM"
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '24px' }}>
              {/* ลักษณะงาน */}
              <div>
                <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', color: '#374151', marginBottom: '8px' }}>ลักษณะงาน</label>
                <input
                  type="text"
                  style={{
                    width: '100%',
              ...
              {/* จังหวัดที่ทำงาน */}
              <div>
                <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', color: '#374151', marginBottom: '8px' }}>จังหวัดที่ทำงาน</label>
                <select style={{
                  width: '100%',
                  padding: '8px 12px',
                  border: '1px solid #d1d5db',
          ...
          {/* หน้าที่ความรับผิดชอบ Section */}
          <div style={{ marginBottom: '24px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
              <label style={{ fontSize: '18px', fontWeight: '500', color: '#1f2937' }}>หน้าที่ความรับผิดชอบ (โดยสังเขป)</label>
