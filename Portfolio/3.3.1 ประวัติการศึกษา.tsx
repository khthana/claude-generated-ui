              ...
              <div className="form-section">
                ...
                <div className="education-row">
                  <div className="education-field">
                    <label className="form-label">ปีจบการศึกษา (พ.ศ.)</label>
                ...
                <div className="education-row">
                  <div className="education-field">
                    <label className="form-label">สถาบันการศึกษา</label>
                    <input type="text" className="form-input" />
                  </div>
                  <div className="education-field">
                  ...
                  <div className="education-field-small">
                    <label className="form-label">เกรดเฉลี่ย</label>
                    <input type="text" className="form-input" />
                  </div>
                </div>
                ...
                <div className="checkbox-item">
                  ...
                  <label htmlFor="showResume" className="checkbox-text">แสดงบนหน้าเรซูเม่</label>
                </div>
              </div>
