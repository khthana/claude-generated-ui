...
import { Search, Plus, Edit, MoreHorizontal, RefreshCw, MessageSquare, User, Bell, ChevronDown, ChevronRight, X, Settings, Key, ChevronLeft, ChevronsLeft, ChevronsRight, Trash2 } from 'lucide-react';

const UserManagementSystem = () => {
  const [activeTab, setActiveTab] = useState('ข้อมูลรายวิชา');
  ...
  const dropdownMenus = [
    {
      name: 'ข้อมูลหลัก',
      items: ['ข้อมูลภาควิชา', 'ข้อมูลหลักสูตร', 'ข้อมูลรายวิชา']
    },
    {
      name: 'ตั้งค่า',
      items: ['ผู้ใช้งานระบบ']
    ...
    {
      name: 'หลักสูตร', 
      items: ['จัดการรายวิชาในหลักสูตร']
    },
    {
      name: 'ผลการเรียนรู้',
      items: ['กำหนดผลการเรียนรู้', 'Map ผลการเรียนรู้ กับ รายวิชา']
    }
  ];
      ...
      <div className="flex">
        ...
        <div className="flex-1 p-6">
          ...
          <div className="mb-4">
            ...
            <span className="text-sm text-gray-700">ข้อมูลรายวิชา</span>
          </div>
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex space-x-2">
              <button className="bg-sky-300 hover:bg-sky-400 text-white px-4 py-2 rounded-md text-sm font-medium">
                นำเข้าข้อมูล
              </button>
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium">
                เพิ่มข้อมูล
            ...
            <table className="w-full">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">01076002</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Programming Fundamental</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">พื้นฐานการเขียนโปรแกรมคอมพิวเตอร์</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">3</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex space-x-2">
                      <button 
                        onClick={openEditModal}
                        className="border border-green-600 text-green-600 p-1.5 rounded hover:bg-green-50 transition-colors duration-200"
                        title="แก้ไข"
                      >
                        <Edit className="w-4 h-4" />
                      </button>
                      <button 
                        className="border border-red-600 text-red-600 p-1.5 rounded hover:bg-red-50 transition-colors duration-200"
                        title="ลบข้อมูล"
                      >
                ...
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">01076046</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Data Structures and Algorithms</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">โครงสร้างข้อมูลและขั้นตอนวิธี</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">3</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex space-x-2">
                      <button 
                ...
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">01076263</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Database Systems</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">ระบบฐานข้อมูล</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">3</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex space-x-2">
                      <button 
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <div className="flex items-center space-x-1">
              <button className="p-2 rounded border border-gray-300 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed">
                <ChevronsLeft className="w-4 h-4" />
              </button>
              <button className="p-2 rounded border border-gray-300 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed">
                <ChevronLeft className="w-4 h-4" />
              </button>
              <button className="px-3 py-2 rounded border border-cyan-500 bg-transparent text-cyan-600 hover:bg-cyan-50">
                1
              </button>
              <button className="p-2 rounded border border-gray-300 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed">
                <ChevronRight className="w-4 h-4" />
