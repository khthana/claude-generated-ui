...
import { Search, Plus, Edit, MoreHorizontal, RefreshCw, MessageSquare, User, Bell, ChevronDown, ChevronRight, X, Settings, Key, ChevronsLeft, ChevronLeft, ChevronsRight, Trash2, Upload } from 'lucide-react';

const UserManagementSystem = () => {
  const [activeTab, setActiveTab] = useState('รายวิชาในหลักสูตร');
  const [searchTerm, setSearchTerm] = useState('');
  const [expandedMenus, setExpandedMenus] = useState({ 'ข้อมูลหลัก': true, 'ตั้งค่า': true, 'หลักสูตร': false, 'ผลการเรียนรู้': false });
      ...
      <div className="flex">
        ...
        <div className="flex-1 p-6">
          ...
          <div className="mb-4">
            ...
            <span className="text-sm text-gray-700">รายวิชาในหลักสูตร</span>
          </div>

          {/* Header */}
          <h1 className="text-2xl font-bold text-gray-800 mb-6">รายวิชาในหลักสูตร</h1>
          ...
          <div className="mb-6 bg-white p-4 rounded-lg border border-gray-200">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <button className="bg-cyan-500 hover:bg-cyan-600 text-white px-4 py-2 rounded-md text-sm font-medium flex items-center space-x-2">
          ...
          <div className="bg-white rounded-lg border border-gray-200">
              ...
              <table className="w-full">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4 text-sm text-gray-900">01076001</td>
                    <td className="px-6 py-4 text-sm text-gray-900">
                      <div>Introduction to Computer Engineering</div>
                      <div className="text-gray-500">ความรู้เบื้องต้นวิศวกรรมคอมพิวเตอร์</div>
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-900">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex space-x-2">
                        <button 
                          ...
                          className="p-2 border border-green-600 text-green-600 hover:bg-green-50 hover:text-green-700 rounded"
                        >
                          <Edit className="w-4 h-4" />
                        </button>
                        <button className="p-2 border border-red-600 text-red-600 hover:bg-red-50 hover:text-red-700 rounded">
                  ...
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4 text-sm text-gray-900">01078005</td>
                    <td className="px-6 py-4 text-sm text-gray-900">
                      <div>Data Structures and Algorithms</div>
                      <div className="text-gray-500">โครงสร้างข้อมูลและขั้นตอนวิธี</div>
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-900">
                      <select className="border border-gray-300 rounded-md px-2 py-1 text-sm bg-white">
                        <option value="required">วิชาบังคับ</option>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex space-x-2">
                        <button className="p-2 border border-green-600 text-green-600 hover:bg-green-50 hover:text-green-700 rounded">
                          <Edit className="w-4 h-4" />
                        </button>
                        <button className="p-2 border border-red-600 text-red-600 hover:bg-red-50 hover:text-red-700 rounded">
                          <Trash2 className="w-4 h-4" />
                  ...
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4 text-sm text-gray-900">01070006</td>
                    <td className="px-6 py-4 text-sm text-gray-900">
                      <div>Digital System Fundamentals</div>
                      <div className="text-gray-500">พื้นฐานระบบดิจิตอล</div>
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-900">
                      <select className="border border-gray-300 rounded-md px-2 py-1 text-sm bg-white">
                        <option value="required">วิชาบังคับ</option>
            ...
            <div className="flex items-center justify-between px-6 py-4 border-t border-gray-200">
              <span className="text-sm text-gray-500">1-3 of 34 items</span>
              <div className="flex items-center space-x-1">
                ...
                <button className="bg-transparent text-cyan-600 border border-cyan-500 hover:bg-cyan-50 px-3 py-1 rounded text-sm font-medium">
                  1
                </button>
                <button className="text-gray-500 hover:text-gray-700 hover:bg-gray-100 px-3 py-1 rounded text-sm">2</button>
                <button className="text-gray-500 hover:text-gray-700 hover:bg-gray-100 px-3 py-1 rounded text-sm">3</button>
                <button className="text-gray-500 hover:text-gray-700 hover:bg-gray-100 px-3 py-1 rounded text-sm">4</button>
                <button className="text-gray-500 hover:text-gray-700 hover:bg-gray-100 px-3 py-1 rounded text-sm">5</button>
                <button className="p-1 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded">
                  <ChevronRight className="w-4 h-4" />
                </button>
                <button className="p-1 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded">
