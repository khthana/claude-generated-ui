    ...
    <div className="min-h-screen bg-gray-50 font-sans" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
      ...
      <div className="flex">
        ...
        <div className="flex-1 p-6">
          {/* Breadcrumb */}
          <div className="mb-4">
            <span className="text-sm text-blue-600 cursor-pointer hover:underline">ผู้ใช้งานระบบ</span>
            <span className="text-sm text-gray-500 mx-2">/</span>
            <span className="text-sm text-gray-700">แก้ไขผู้ใช้งานระบบ</span>
          </div>

          {/* Page Title */}
          <h1 className="text-2xl font-bold text-gray-800 mb-6">แก้ไขผู้ใช้งานระบบ</h1>

          {/* Tabs */}
          <div className="border-b border-gray-200 mb-6">
            <div className="flex">
              <button
                className="flex items-center space-x-2 px-6 py-3 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
              >
                <User className="w-4 h-4" />
                <span>ข้อมูลทั่วไป</span>
              </button>
              <button
                className="flex items-center space-x-2 px-6 py-3 text-sm font-medium border-b-2 border-blue-500 text-blue-600 bg-blue-50"
              >
                <Settings className="w-4 h-4" />
                <span>สิทธิ์ของระบบ</span>
              </button>
              <button
                className="flex items-center space-x-2 px-6 py-3 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
              >
          ...
          <div className="bg-white">
            <h3 className="text-lg font-medium text-gray-800 mb-6">สิทธิ์ของระบบ</h3>
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="text-sm font-medium text-blue-600">ผู้ดูแลระบบระดับคณะ</h4>
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  ...
                  <div className="ml-4 text-gray-500">ผู้ดูแลระบบระดับคณะ</div>
                </div>
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="text-sm font-medium text-blue-600">ผู้ดูแลระบบระดับภาควิชา</h4>
                  <ChevronDown className="w-4 h-4 text-gray-400" />
                </div>
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  ...
                  <div className="ml-4 text-gray-500">ผู้ดูแลระบบระดับภาควิชา</div>
                  
                  <div className="text-gray-600 underline">ภาควิชา</div>
                  <div className="ml-4 text-gray-500">วิศวกรรมคอมพิวเตอร์</div>
                </div>
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="text-sm font-medium text-blue-600">กรรมการหลักสูตร</h4>
                  <ChevronDown className="w-4 h-4 text-gray-400" />
                </div>
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  ...
                  <div className="ml-4 text-gray-500">กรรมการหลักสูตร</div>
                  
                  <div className="mt-2">
                    <div className="text-gray-600 underline">ภาควิชา</div>
                    <div className="ml-4 text-gray-500">วิศวกรรมคอมพิวเตอร์</div>
                    
                    <div className="text-gray-600 underline mt-1">หลักสูตร</div>
                    <div className="ml-4 text-gray-500">วิศวกรรมคอมพิวเตอร์</div>
                  </div>
                </div>
