...
const UserManagementSystem = () => {
  const [activeTab, setActiveTab] = useState('ผลการเรียนรู้ระดับหลักสูตร');
      ...
      <div className="flex">
        ...
        <div className="flex-1 p-6">
          ...
          <div className="mb-4">
            ...
            <span className="text-sm text-gray-700">ผลการเรียนรู้ระดับหลักสูตร</span>
          </div>

          {/* Header */}
          <h1 className="text-2xl font-bold text-gray-800 mb-6">กำหนดผลการเรียนรู้ระดับหลักสูตร (PLO)</h1>
          ...
          <div className="bg-white rounded-lg border border-gray-200">
            <div className="p-4">
              ...
              <div className="flex items-center justify-between mb-0 p-3 bg-gray-50">
                <span className="text-lg font-medium text-gray-800">ผลการเรียนรู้</span>
              ...
              {/* Table Header */}
              <div className="grid grid-cols-12 gap-4 p-3 bg-gray-100 text-sm font-medium text-gray-700">
                <div className="col-span-1">ข้อ</div>
                <div className="col-span-9">ชื่อผลการเรียนรู้</div>
                <div className="col-span-2">ดำเนินการ</div>
              </div>

              <div className="space-y-1">
                {/* Main Item 1 with expanded sub-items */}
                <div className="border border-gray-200">
                  <div className="grid grid-cols-12 gap-4 p-3 bg-blue-50 items-center border-b border-gray-200">
                    <div className="col-span-1 flex items-center">
                      <button className="mr-2">
                        <ChevronDown className="w-4 h-4 text-gray-500" />
                      </button>
                      <span className="text-sm font-medium">PLO-1</span>
                    </div>
                    <div className="col-span-9">
                      <input 
                        type="text" 
                        defaultValue="ความรู้และความเข้าใจหลักฟิสิกส์"
                        className="w-full p-2 border border-gray-300 rounded-md text-sm"
                      />
                    </div>
                    <div className="col-span-2">
                      <div className="flex space-x-2">
                        <button className="text-green-600 hover:text-green-700 hover:bg-green-50 p-1 border border-green-600 rounded hover:border-green-700 transition-colors">
                          <Edit className="w-4 h-4" />
                        </button>
                        <button className="text-red-600 hover:text-red-700 hover:bg-red-50 p-1 border border-red-600 rounded hover:border-red-700 transition-colors">
                  ...
                  <div className="border-t border-gray-200 bg-white">
                    <div className="grid grid-cols-12 gap-4 p-2 items-center border-b border-gray-100">
                      <div className="col-span-1 text-xs text-gray-600 pl-8">PLO-1.1</div>
                      <div className="col-span-9">
                        <input 
                          type="text" 
                          defaultValue="อธิบายหลักการพื้นฐานของฟิสิกส์ สัมพันธภาพ เทคโนโลยี"
                    ...
                    <div className="grid grid-cols-12 gap-4 p-2 items-center border-b border-gray-100">
                      <div className="col-span-1 text-xs text-gray-600 pl-8">PLO-1.2</div>
                      <div className="col-span-9">
                        <input 
                          type="text" 
                          defaultValue="เป็นประโยชน์ต่อการออกแบบและพัฒนาระบบทางวิศวกรรม"
                          className="w-full p-2 border border-gray-300 rounded-md text-xs"
                        />
                      </div>
                      <div className="col-span-2">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-2 items-center border-b border-gray-100">
                      <div className="col-span-1 text-xs text-gray-600 pl-8">PLO-1.3</div>
                      <div className="col-span-9">
                        <input 
                          type="text" 
                          defaultValue="นำความรู้ด้านฟิสิกส์ไปใช้เป็น ศาสตร์เพื่อแก้ปัญหาทางด้านวิศวกรรมให้ได้อย่างมีประสิทธิภาพ"
                          className="w-full p-2 border border-gray-300 rounded-md text-xs"
                        />
                      </div>
                      <div className="col-span-2">
                    ...
                    <div className="p-3 border-t border-gray-100">
                      <button className="text-blue-600 hover:text-blue-700 text-xs font-medium border border-blue-600 px-2 py-1 rounded">
                        + เพิ่ม
                      </button>
                    </div>
                  </div>
                ...
                {/* Main Item 2 - Collapsed */}
                <div className="grid grid-cols-12 gap-4 p-3 border-x border-b border-gray-200 items-center hover:bg-gray-50">
                  <div className="col-span-1 flex items-center">
                    <button className="mr-2">
                      <ChevronRight className="w-4 h-4 text-gray-500" />
                    </button>
                    <span className="text-sm font-medium">PLO-2</span>
                  </div>
                  <div className="col-span-9">
                    <input 
                      type="text" 
                      defaultValue="ความรู้"
                      className="w-full p-2 border border-gray-300 rounded-md text-sm"
                    />
                  </div>
                  <div className="col-span-2">
                ...
                {/* Main Item 3 - Collapsed */}
                <div className="grid grid-cols-12 gap-4 p-3 border-x border-b border-gray-200 items-center hover:bg-gray-50">
                  <div className="col-span-1 flex items-center">
                    <button className="mr-2">
                      <ChevronRight className="w-4 h-4 text-gray-500" />
                    </button>
                    <span className="text-sm font-medium">PLO-3</span>
                  </div>
                  <div className="col-span-9">
                    <input 
                      type="text" 
                      defaultValue="ทักษะทางปัญญา"
                      className="w-full p-2 border border-gray-300 rounded-md text-sm"
                    />
                  </div>
                  <div className="col-span-2">
                ...
                <div className="grid grid-cols-12 gap-4 p-3 border-x border-b border-gray-200 items-center hover:bg-gray-50">
                  <div className="col-span-1 flex items-center">
                    ...
                    <span className="text-sm font-medium">PLO-4</span>
                  </div>
                  <div className="col-span-9">
                    <input 
                      type="text" 
                      defaultValue="ผลการเรียนรู้ของหลักสูตร: PLO"
                      className="w-full p-2 border border-gray-300 rounded-md text-sm"
                    />
                  </div>
                  <div className="col-span-2">
