...
import { Search, Plus, Edit, MoreHorizontal, RefreshCw, MessageSquare, User, Bell, ChevronDown, ChevronRight, X, Settings, Key, Trash2, ChevronsLeft, ChevronLeft, ChevronsRight } from 'lucide-react';

const UserManagementSystem = () => {
  const [activeTab, setActiveTab] = useState('ข้อมูลภาควิชา');
  const [searchTerm, setSearchTerm] = useState('');
  const [expandedMenus, setExpandedMenus] = useState({ 'ข้อมูลหลัก': true, 'ผู้ใช้': true, 'หลักสูตร': false, 'ผลการเรียนรู้': false, 'รายวิชา': false, 'การประเมิน': false, 'รายงาน': false });
        ...
        <div className="flex-1 p-6">
            ...
            <table className="w-full">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Telecommunication Engineering</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">วิศวกรรมโทรคมนาคม</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex space-x-2">
                      <button 
                        onClick={openEditModal}
                        className="border border-green-600 text-green-600 hover:bg-green-50 p-1.5 rounded flex items-center justify-center transition-colors duration-200"
                        title="แก้ไข"
                      >
                        <Edit className="w-4 h-4" />
                      </button>
                      <button 
                        className="border border-red-600 text-red-600 hover:bg-red-50 p-1.5 rounded flex items-center justify-center transition-colors duration-200"
                        title="ลบข้อมูล"
                      >
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Electrical Engineering</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">วิศวกรรมไฟฟ้า</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex space-x-2">
                      <button 
                        onClick={openEditModal}
                ...
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">05</td>
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <div className="flex items-center space-x-1">
              <button className="p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded border border-gray-300" title="First Page">
                <ChevronsLeft className="w-4 h-4" />
              </button>
              <button className="p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded border border-gray-300" title="Previous">
                <ChevronLeft className="w-4 h-4" />
              </button>
              <button className="px-3 py-2 text-cyan-600 bg-transparent border border-cyan-500 hover:bg-cyan-50 rounded text-sm font-medium">
                1
              </button>
              <button className="p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded border border-gray-300" title="Next">
                <ChevronRight className="w-4 h-4" />
              </button>
              <button className="p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded border border-gray-300" title="Last Page">
