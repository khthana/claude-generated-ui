            ...
            {editModalTab === 'ข้อมูลทั่วไป' && (
              <div>
                ...
                <div className="space-y-6">
                  {/* Row 1: รหัสผู้ใช้, E-Mail, โทรศัพท์ */}
                  ...
                  {/* Row 2: คำนำหน้า(ไทย), ชื่อ(ไทย), นามสกุล(ไทย) */}
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        คำนำหน้า(ไทย)
                  ...
                  {/* Row 3: คำนำหน้า(อังกฤษ), ชื่อ(อังกฤษ), นามสกุล(อังกฤษ) */}
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        คำนำหน้า(อังกฤษ)
                  ...
                  <div className="flex space-x-4">
                    <div className="flex-1">
                      ...
                      >
                        ...
                        <option value="ภาควิชาวิศวกรรมโทรคมนาคม">ภาควิชาวิศวกรรมโทรคมนาคม</option>
                        <option value="ภาควิชาวิศวกรรมไฟฟ้า">ภาควิชาวิศวกรรมไฟฟ้า</option>
                    ...
                    <div className="flex-1">
                      ...
                      >
                        ...
                        <option value="วิศวกรรมศาสตรบัณฑิต">วิศวกรรมศาสตรบัณฑิต</option>
