...
const UserManagementSystem = () => {
  const [activeTab, setActiveTab] = useState('ผลการเรียนรู้ระดับหลักสูตร รายบุคคล');
      ...
      <div className="flex">
        ...
        <div className="flex-1 p-6">
          ...
          <div className="mb-4">
            ...
            <span className="text-sm text-gray-700">ผลการเรียนรู้ระดับหลักสูตร รายบุคคล</span>
          </div>

          {/* Header */}
          <h1 className="text-2xl font-bold text-gray-800 mb-6">ผลการเรียนรู้ระดับหลักสูตร รายบุคคล</h1>
          ...
          <div className="mb-6 bg-white p-4 rounded-lg border border-gray-200">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <select className="border border-gray-300 rounded-md px-3 py-2 text-sm bg-white min-w-[140px]">
                  <option value="68010111">68010111</option>
                  <option value="68010112">68010112</option>
                  <option value="68010113">68010113</option>
                  <option value="68010114">68010114</option>
                  <option value="68010115">68010115</option>
                </select>
